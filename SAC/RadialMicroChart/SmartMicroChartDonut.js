(function() {
    ...
    function loadthis(that, changedProperties) {
        ...
        if(that._firstConnection === 0) {
        	...
        	div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View xmlns="sap.suite.ui.microchart" xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc" controllerName="myView.Template"><RadialMicroChart size="L" percentage="' + percentage + '" press="onPress" class="sapUiSmallMargin"></RadialMicroChart></mvc:View></script>';
